...
aug_root = cfg.DATASET.IDD_AUG_DIR
img_postfix_jpg = '_leftImg8bit.jpg'
img_postfix_png = '_leftImg8bit.png'
...
def gen_id_to_ignore(num_classes):
    ...
    if num_classes == 19:
        ...
        ### Road
        id_to_ignore_or_group[0] = 0

        ### Sidewalk
        id_to_ignore_or_group[3] = 1

        ### Building
        id_to_ignore_or_group[29] = 2

        ### Wall
        id_to_ignore_or_group[20] = 3

        ### Fence
        id_to_ignore_or_group[21] = 4

        ### Pole
        id_to_ignore_or_group[26] = 5

        ### Traffic Light
        id_to_ignore_or_group[25] = 6

        ### Traffic Sign
        id_to_ignore_or_group[24] = 7

        ### Vegetation
        id_to_ignore_or_group[32] = 8

        ### Terrain
        id_to_ignore_or_group[5] = 9

        ### Sky
        id_to_ignore_or_group[33] = 10

        ### Person
        id_to_ignore_or_group[6] = 11

        ### Rider
        id_to_ignore_or_group[8] = 12

        ### Car
        id_to_ignore_or_group[12] = 13

        ### Truck
        id_to_ignore_or_group[13] = 14

        ### Bus
        id_to_ignore_or_group[14] = 15

        ### Train
        id_to_ignore_or_group[17] = 16

        ### Motorcycle
        id_to_ignore_or_group[9] = 17

        ### Bicycle
        id_to_ignore_or_group[10] = 18
        ...
        id_to_ignore_or_group[0] = 0
        # Drivable fallback
        id_to_ignore_or_group[2] = 0
        # sidewalk
        id_to_ignore_or_group[3] = 0

        ### Construction
        # Curb
        id_to_ignore_or_group[19] = 1
        # Wall
        id_to_ignore_or_group[20] = 1
        # Fence
        id_to_ignore_or_group[21] = 1
        # Building
        id_to_ignore_or_group[29] = 1

        ### Object
        # Bilboard
        id_to_ignore_or_group[23] = 2
        # Traffic sign
        id_to_ignore_or_group[24] = 2
        # Traffic light
        id_to_ignore_or_group[25] = 2
        # Pole
        id_to_ignore_or_group[26] = 2

        ### Nature
        # vegetation
        id_to_ignore_or_group[32] = 3

        ### Sky
        # sky
        id_to_ignore_or_group[33] = 4

        ### Human
        # Person
        id_to_ignore_or_group[6] = 5
        # Rider
        id_to_ignore_or_group[8] = 5

        ### Vehicle
        # Motocycle
        id_to_ignore_or_group[9] = 6
        # Bicycle
        id_to_ignore_or_group[10] = 6
        # Autorickshaw
        id_to_ignore_or_group[11] = 6
        # Car
        id_to_ignore_or_group[12] = 6
        # Truck
        id_to_ignore_or_group[13] = 6
        # Bus
        id_to_ignore_or_group[14] = 6
        # Caravan
        id_to_ignore_or_group[15] = 6
        # Trailer
        id_to_ignore_or_group[16] = 6
        # Train
        id_to_ignore_or_group[17] = 6
        # Vehiclefallback
        id_to_ignore_or_group[18] = 6
...
def add_items(items, aug_items, cities, img_path, mask_path, mask_postfix, mode, maxSkip):
    ...
    for c in cities:
        ...
        for name in os.listdir(os.path.join(img_path, c)):
            if name.endswith(img_postfix_jpg):
                img_postfix=img_postfix_jpg
                c_items.append(name.split(img_postfix)[0])
            elif name.endswith(img_postfix_png):
                img_postfix=img_postfix_png
                c_items.append(name.split(img_postfix)[0])
        for it in c_items:
...
def make_dataset(mode, maxSkip=0, cv_split=0):
    ...
    for mode in modes:
        if mode == 'test':
            ...
            # logging.info('{} idd segmentation : '.format(mode) + str(cv_splits[cv_split][mode]))
    ...
    logging.info('Idd-{}: {} images'.format(mode, len(items) + len(aug_items)))
...
class Idd(data.Dataset):
    ...
    def __init__(self, mode, maxSkip=0, joint_transform=None, sliding_crop=None,
                 ...
                 eval_scales=None, eval_flip=False, image_in=False, extract_feature=False,meta_transform = None, num_classes=19):
        gen_id_to_ignore(num_classes)
        self.mode = mode
...
class IddUniform(data.Dataset):
    ...
    def __init__(self, mode, maxSkip=0, joint_transform_list=None, sliding_crop=None,
                 ...
                 test=False, coarse_boost_classes=None, image_in=False, extract_feature=False, num_classes=19):
        self.mode = mode
        self.maxSkip = maxSkip
        ...
        json_fn = 'idd_{}_cv{}_tile{}.json'.format(
