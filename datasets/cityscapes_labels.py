...
labels = [
    ...
    Label(  'polegroup'            , 18 ,      255 , 'object'          , 2       , False        , True         , (153,153,154) ),   # (153,153,153)
    ...
    Label(  'license plate'        , -1 ,       -1 , 'vehicle'         , 6       , False        , True         , (  0,  0,143) ),   # (  0,  0,142)
]
...
# label2catid
label2catid   = { label.id      : label.categoryId for label in labels   }
# trainId to label object
