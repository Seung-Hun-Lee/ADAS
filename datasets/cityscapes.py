...
def gen_id_to_ignore(num_classes):
    ...
    if num_classes == 19:
        id_to_ignore_or_group = cityscapes_labels.label2trainid
    elif num_classes == 7:
        id_to_ignore_or_group = cityscapes_labels.label2catid
...
class CityScapes(data.Dataset):
    ...
    def __init__(self, quality, mode, maxSkip=0, joint_transform=None, sliding_crop=None,
                 ...
                 eval_scales=None, eval_flip=False, image_in=False, extract_feature=False, num_classes=19):
    ...
    def __init__(self, quality, mode, maxSkip=0, joint_transform_list=None, sliding_crop=None,
        ...
        if os.path.isfile(json_fn):
            ...
            self.centroids = uniform.class_centroids_all(
                self.imgs,
                num_classes,
                id2trainid=id_to_ignore_or_group,
